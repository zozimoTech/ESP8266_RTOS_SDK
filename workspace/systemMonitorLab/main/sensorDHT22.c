...
char rh_string_dht22[10];
char temp_string_dht22[10];
...
//	printf( "Starting DHT Task\n\n");
	...
	while(1) {
		...
		errorHandler(ret);
		floatToString(getHumidity(),rh_string_dht22,2);
		floatToString(getTemperature(),temp_string_dht22,2);
		ESP_LOGI(TAG, "*******************\n");
		ESP_LOGI(TAG, "Temp_DHT22: %s",temp_string_dht22);
		ESP_LOGI(TAG, "RH_DHT22: %s",rh_string_dht22);
