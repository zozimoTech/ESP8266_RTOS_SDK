...
#define PWM_0_OUT_IO_NUM   5  //Led amarillo
#define PWM_1_OUT_IO_NUM   12 //Led rojo
#define PWM_2_OUT_IO_NUM   13 //Led verde
...
void app_main()
{
    ...
    while (1) {
        ...
        // count++;
        duties[2] = duties[2] + 100;
        if (duties[2] >= 1000) {
            duties[2] = 0;
        }
        ESP_LOGI(TAG, "Duty cycle: %u\n", duties[2]);
